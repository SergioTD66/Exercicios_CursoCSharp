namespace Exercicio04_1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("(List) Um cinema que possui capacidade de 100 lugares está sempre com ocupação total.\r\nCerto dia cada espectador respondeu a um questionário, no qual constava: sua idade e\r\nsua opinião em relação ao filme (que podia ser ótimo, bom, regular, ruim ou péssimo).\r\nElabore um programa que, lendo estes dados, responda:\r\n• a quantidade de respostas ótimo;\r\n• a média de idade das pessoas que responderam ruim;\r\n• a porcentagem de respostas péssimo e a maior idade que utilizou esta opção.");
            Console.WriteLine("\nResposta:\n");
